...
youtube-upload --tags=$WEATHER_CAM_VID_TAGS -d $WEATHER_CAM_VID_DESCRIPTION --title "WEATHER_CAM_VID_TITLE $YEAR Day $DAY" --privacy=public --playlist=$WEATHER_CAM_VID_PLAYLIST --client-secrets=$HOME/youtube_client_secret.json ~/videos/$YEAR-$DAY/$YEAR-$DAY-h264.avi
